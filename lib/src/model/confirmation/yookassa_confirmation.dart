...
class YookassaConfirmation with _$YookassaConfirmation {
  ...
  factory YookassaConfirmation.embedded({
  ...
  factory YookassaConfirmation.external({
    @Default('ru_RU') String? locale,
  ...
  factory YookassaConfirmation.mobileApplication({
    @Default('ru_RU') String? locale,
    String? returnUrl,
  ...
  factory YookassaConfirmation.qr({
    @Default('ru_RU') String? locale,
  ...
  factory YookassaConfirmation.redirect({
    @Default('ru_RU') String? locale,
    String? returnUrl,
    String? confirmationUrl,
    bool? enforce,
