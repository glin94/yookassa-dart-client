...
extension AmountPatterns on Amount {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Amount value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String value, String currency)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _Amount extends Amount {
  const _Amount({required this.value, required this.currency}) : super._();
