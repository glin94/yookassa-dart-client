...
YookassaCard _$YookassaCardFromJson(Map<String, dynamic> json) {
  return _YookassaCard.fromJson(json);
}
...
/// @nodoc
abstract class $YookassaCardCopyWith<$Res> {
  factory $YookassaCardCopyWith(
          YookassaCard value, $Res Function(YookassaCard) then) =
...
/// @nodoc
class _$YookassaCardCopyWithImpl<$Res, $Val extends YookassaCard>
    implements $YookassaCardCopyWith<$Res> {
  _$YookassaCardCopyWithImpl(this._value, this._then);
